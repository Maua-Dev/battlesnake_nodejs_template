...
locals {
  ...
  # Zip com dist/ + node_modules de produção, montado pelo CD
...
resource "aws_lambda_function" "battlesnake" {
  ...
  # "dist/src/index.handler" = a constante `handler` exportada por src/index.ts,
  # depois de compilada pelo tsc para dist/src/index.js.
  runtime       = "nodejs20.x"
...
resource "aws_api_gateway_rest_api" "api" {
  ...
  description = "API da cobra ${var.project_name} (TypeScript)"
}
